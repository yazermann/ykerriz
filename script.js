...
(() => {
  ...
  // Accordéon principal : un seul item ouvert à la fois, par bloc accordéon
  // (le bloc Compétences et le bloc Portfolio restent indépendants).
  $$('.acc-trigger').forEach(trigger => {
    ...
    trigger.addEventListener('click', () => {
      ...
      $$('.acc-trigger', scope).forEach(other => {
